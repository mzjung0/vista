...
klaseko.directive('salesmenUpdate', ['Restangular', function(Restangular) {
  return {
    restrict: 'A',
    scope: {
      data: '=data'
    ...
    template: '<td><span>{{data.id}}</span></td>' +
              '<td><input type="text" ng-model=data.salesman_code placeholder="Salesman Code" /></td>' +
              '<td><input type="text" ng-model=data.salesman_name placeholder="Salesman Name" /></td>' +
...
klaseko.directive('salesmenAdd', ['Restangular', function(Restangular) {
  return {
    restrict: 'A',
    scope: {
      endpoint: '@'
